...
class AnswerCard extends React.Component {
    ...
    render() {
        return (
            <button className={`card primary-dark-theme text-dark-theme p-2 h-100 w-100 overflow-auto text-center btn answer-button${this.state.answersSelected.includes(this.state.answer) ? " selected" : " selected"}`}
